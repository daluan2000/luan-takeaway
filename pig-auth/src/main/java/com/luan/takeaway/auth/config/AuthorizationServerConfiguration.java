...
package com.luan.takeaway.auth.config;

import com.luan.takeaway.auth.support.CustomeOAuth2AccessTokenGenerator;
import com.luan.takeaway.auth.support.core.CustomeOAuth2TokenCustomizer;
import com.luan.takeaway.auth.support.core.FormIdentityLoginConfigurer;
import com.luan.takeaway.auth.support.core.PigDaoAuthenticationProvider;
import com.luan.takeaway.auth.support.filter.PasswordDecoderFilter;
import com.luan.takeaway.auth.support.filter.ValidateCodeFilter;
import com.luan.takeaway.auth.support.handler.PigAuthenticationFailureEventHandler;
import com.luan.takeaway.auth.support.handler.PigAuthenticationSuccessEventHandler;
import com.luan.takeaway.auth.support.password.OAuth2ResourceOwnerPasswordAuthenticationConverter;
import com.luan.takeaway.auth.support.password.OAuth2ResourceOwnerPasswordAuthenticationProvider;
import com.luan.takeaway.auth.support.sms.OAuth2ResourceOwnerSmsAuthenticationConverter;
import com.luan.takeaway.auth.support.sms.OAuth2ResourceOwnerSmsAuthenticationProvider;
import com.luan.takeaway.common.core.constant.SecurityConstants;
import com.luan.takeaway.common.security.component.PigBootCorsProperties;
