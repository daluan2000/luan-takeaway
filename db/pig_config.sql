...
-- 数据库： `pig_config`
--
CREATE DATABASE IF NOT EXISTS `pig_config` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci;
USE `pig_config`;
...
--
ALTER TABLE `config_info`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id', AUTO_INCREMENT=12;
