...
-- --------------------------------------------------------
-- 新增：批量操作菜单及权限配置（2026-03-31）
-- 功能说明：管理员和商家可批量操作用户、菜品等数据，提高数据初始化和迁移效率
-- --------------------------------------------------------

-- 批量操作目录菜单
(2033000000000000001, '批量操作', NULL, NULL, '/admin/batch', 1000, 'ele-Tools', '1', 4, '0', NULL, '0', 'admin', '2026-03-31 21:00:00', NULL, NULL, '0'),

-- 批量注册用户接口权限（管理员专用）
-- 接口：POST /user/batch/register
-- 功能：批量创建系统用户，支持客户、商家、骑手三种角色
(2033000000000000002, '用户批量注册', NULL, 'sys_user_batch_register', NULL, 2033000000000000001, NULL, '1', 1, '0', NULL, '1', 'admin', '2026-03-31 21:00:00', NULL, NULL, '0'),

-- 批量导入用户扩展信息接口权限（管理员专用）
-- 接口：POST /takeaway/user/ext/batch/import
-- 功能：批量导入客户、商家、骑手的扩展信息（如店铺资料、配送范围等）
(2033000000000000003, '用户扩展批量导入', NULL, 'sys_user_ext_batch_import', NULL, 2033000000000000001, NULL, '1', 2, '0', NULL, '1', 'admin', '2026-03-31 21:00:00', NULL, NULL, '0'),

-- 管理员批量导入菜品接口权限（管理员专用）
-- 接口：POST /takeaway/dish/batch/import
-- 功能：管理员批量导入菜品，可指定商家或批量为同一商家导入
(2033000000000000004, '菜品批量导入', NULL, 'wm_dish_batch_import', NULL, 2033000000000000001, NULL, '1', 3, '0', NULL, '1', 'admin', '2026-03-31 21:00:00', NULL, NULL, '0'),

-- 商家批量导入菜品接口权限（商家专用）
-- 接口：POST /takeaway/dish/merchant/batch/import
-- 功能：商家批量导入自己的菜品，自动使用当前登录商家的用户ID
(2033000000000000005, '商家菜品批量导入', NULL, 'wm_merchant_dish_batch_import', NULL, 2033000000000000001, NULL, '1', 4, '0', NULL, '1', 'admin', '2026-03-31 21:00:00', NULL, NULL, '0');
...
(1, 2033000000000000001),
(1, 2033000000000000002),
(1, 2033000000000000003),
(1, 2033000000000000004),
(1, 2033000000000000005),

-- --------------------------------------------------------
-- 商家角色(3000000000000000101)：仅拥有商家菜品批量导入权限
-- --------------------------------------------------------
(3000000000000000101, 2033000000000000005);
